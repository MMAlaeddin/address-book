...
function MultiAddress(home, work, school, other) {
  this.home = home,
  this.work = work,
  this.school = school,
  this.other = other
...
function displayContactDetails(addressBookToDisplay) {
  ...
  addressBookToDisplay.contacts.forEach(function(contact) {
    htmlForContactInfo += "<li id=" + contact.id + ">" + contact.firstName + " " + contact.lastName + " " + contact.phoneNumber + contact.email + " " + contact.homeAddress + "</li>";
  });
